...
func main() {
    ...
    spider.NewSpider(NewMyPageProcesser(), "sina_stock_news").
        ...
        AddPipeline(pipeline.NewPipelineFile("E:\\tmp\\sinafile\\result")).                                                                       // Print result in file
        OpenFileLog("E:\\tmp\\sinafile").                                                                                                          // Error info or other useful info in spider will be logged in file of defalt path like "WD/log/log.2014-9-1".
